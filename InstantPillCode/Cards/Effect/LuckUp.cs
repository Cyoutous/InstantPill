...
/// <summary>A grade-3 pill that doubles this combat's Gold reward once per stack.</summary>
[CustomID("INSTANTPILL-LUCK_UP")]
public sealed class LuckUp : BaseEffectPillCard
{
    private const string SoundPath = "res://audio/luck up 1.wav";
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await PowerCmd.Apply<LuckUpPower>(
            choiceContext,
            Owner.Creature,
            1m,
            Owner.Creature,
